...
import { ShieldCheck, CheckCircle2, ShoppingBag, ChevronLeft, Lock, ArrowRight } from 'lucide-react'
...
export default function CheckoutPage() {
  ...
  if (success) {
    return (
      <div className="min-h-[70vh] flex items-center justify-center px-4 py-16 text-center">
        <div className="w-full max-w-xl bg-[#161616] border border-[#262626] rounded-2xl p-8 sm:p-12 shadow-2xl space-y-6 flex flex-col items-center animate-in fade-in">
          ...
          <div className="space-y-2">
            <span className="text-xs font-bold text-zinc-400 uppercase tracking-widest">Order Confirmed</span>
            <h1 className="text-2xl sm:text-3xl font-extrabold text-white tracking-tight">Order Complete!</h1>
            <p className="text-xs sm:text-sm text-zinc-400 max-w-md leading-relaxed">
              Thank you for your purchase. Your products and VST serial keys have been permanently added to your library.
            </p>
          </div>
          ...
          <div className="pt-4 flex flex-col sm:flex-row gap-3 w-full">
            <Link
              href="/my-purchases"
              prefetch={true}
              className="w-full bg-white hover:bg-zinc-200 text-black font-extrabold text-xs py-3.5 px-6 rounded-full uppercase tracking-wider transition-all shadow-lg text-center cursor-pointer"
            >
              View My Purchases
            </Link>
            <Link
              href="/store"
              prefetch={true}
              className="w-full bg-[#202020] hover:bg-[#282828] text-white font-bold text-xs py-3.5 px-6 rounded-full border border-[#2e2e2e] uppercase tracking-wider transition-all text-center cursor-pointer"
            >
              Continue Shopping
            </Link>
          </div>
  ...
  if (items.length === 0) {
    return (
      <div className="min-h-[70vh] flex items-center justify-center px-4 py-20 text-center">
        <div className="w-full max-w-md bg-[#161616] border border-[#262626] rounded-2xl p-8 sm:p-10 shadow-2xl space-y-4 flex flex-col items-center">
          <div className="w-16 h-16 bg-[#202020] border border-[#2e2e2e] rounded-full flex items-center justify-center mb-2">
          ...
          <div className="pt-3 w-full">
            <Link
              href="/store"
              prefetch={true}
              className="w-full bg-white hover:bg-zinc-200 text-black font-extrabold text-xs py-3.5 px-6 rounded-full inline-block uppercase tracking-wider transition-all shadow-lg text-center cursor-pointer"
            >
              Browse Catalog
            </Link>
          </div>
  ...
  // MAIN CHECKOUT SCREEN (100% Epic Games Store Aesthetic)
  return (
    <div className="w-full min-h-screen bg-[#121212] text-white py-8 sm:py-12">
      <div className="max-w-[1240px] mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            {/* Account Status Card */}
            {!user ? (
              <div className="bg-[#161616] border border-[#262626] rounded-2xl p-5 flex items-center justify-between shadow-md">
                <div className="space-y-1">
              ...
              <div className="bg-[#161616] border border-[#262626] rounded-2xl p-4 flex items-center justify-between shadow-md">
                ...
                <span className="text-[10px] font-bold text-zinc-400 uppercase tracking-widest bg-[#202020] px-2.5 py-1 rounded-full border border-[#2e2e2e]">
                  Linked Account
                </span>
              </div>
            )}
            ...
            {/* Main Form Container */}
            <form onSubmit={handleSimulatePayment} className="bg-[#161616] border border-[#262626] rounded-2xl p-6 sm:p-8 space-y-6 shadow-xl">
              ...
              <div className="space-y-2">
                ...
                <input
                  ...
                  className="w-full bg-[#202020] border border-[#2e2e2e] text-white text-xs px-4 py-3.5 rounded-xl focus:outline-none focus:border-zinc-400 placeholder:text-zinc-500 transition-colors"
                />
              ...
              <div className="space-y-3 pt-2 border-t border-[#262626]">
                ...
                <div className="bg-[#202020] border border-[#2e2e2e] p-4 rounded-xl flex items-center justify-between shadow-sm">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-white hover:bg-zinc-200 text-black font-extrabold text-xs sm:text-sm py-4 rounded-full uppercase tracking-wider flex items-center justify-center gap-2 transition-all shadow-xl cursor-pointer active:scale-[0.99]"
              >
                {loading ? (
          ...
          <div className="lg:col-span-5 space-y-4">
            <div className="bg-[#161616] border border-[#262626] rounded-2xl p-6 sm:p-7 space-y-5 shadow-xl">
              <h3 className="text-xs font-extrabold uppercase tracking-widest text-zinc-300 border-b border-[#262626] pb-3.5 flex items-center justify-between">
              ...
              <div className="space-y-3.5 max-h-72 overflow-y-auto pr-1">
                {items.map((item) => (
                  <div key={item.id} className="flex items-center justify-between gap-3 text-xs">
                    <div className="relative w-12 h-12 bg-[#202020] border border-[#2e2e2e] rounded-xl overflow-hidden flex-shrink-0">
                      <Image
              ...
              <div className="border-t border-[#262626] pt-4 space-y-2 text-xs">
                ...
                <div className="flex justify-between text-base font-extrabold text-white border-t border-[#262626] pt-3">
                  <span>Total Due</span>
