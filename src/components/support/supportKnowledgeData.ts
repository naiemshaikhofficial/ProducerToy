...
export const KNOWLEDGE_BASE: KnowledgeArticle[] = [
  // 1. FREE PRODUCTS & ROYALTIES
  {
    ...
    question: 'Are the plugins and sample packs on Producer Toy really free?',
    shortAnswer: 'Yes! Items in our Free VSTs and Free Samples sections are 100% free to download with zero hidden fees or credit card requirements.',
    detailedSteps: [
      'Navigate to the "Free" menu in the top bar or visit /free-vst-plugins.',
      'Click "Claim Free" or "Get Free" on any free plugin or sample library.',
      'The download link and any applicable lifetime license serial key will be instantly added to your Producer Toy Library (/library).',
      'No subscription or recurring charges will ever be applied for free tier products.',
    ],
    tags: ['are they free', 'free', 'free plugins', 'free samples', 'cost', 'price', 'pricing', 'charge', 'money', 'free download', 'hidden fees', 'zero cost'],
    actionCta: {
      label: 'Browse Free VST Plugins',
  ...
  // 6. REFUND POLICY
  {
    ...
    shortAnswer: 'Digital software serials and sample downloads cannot be revoked once unlocked, but defective products unresolvable by support qualify for replacement or refund.',
    detailedSteps: [
      'Digital Delivery Law: Because digital keys and WAV sample libraries cannot be physically returned or un-read once viewed, orders are generally non-refundable once the serial key has been exposed or file downloaded.',
      'Technical Guarantee: If you encounter an unresolvable technical bug or compatibility defect verified by our technical staff within 7 days of purchase, we will issue a replacement or full refund.',
      'Accidental Duplicate Purchases: If you accidentally purchased the identical plugin twice on the same account, contact us immediately for a full refund or credit swap.',
    ],
    tags: ['refund', 'money back', 'return', 'cancel', 'accidental purchase', 'refund policy', 'duplicate charge', 'satisfaction guarantee'],
    actionCta: {
