...
export function EpicCheckoutLayout({
  ...
  return (
    <div className="w-full max-w-[960px] h-full max-h-screen bg-[#141416] border-x border-[#26262a] rounded-none shadow-[0_30px_90px_rgba(0,0,0,0.95)] flex flex-col md:flex-row overflow-hidden relative select-none font-sans">
      
      {/* ========================================================================= */}
      {/* LEFT COLUMN: ORDER SUMMARY (Large Product Poster & Prominent Typography)   */}
      {/* ========================================================================= */}
      <div className="w-full md:w-[410px] flex-shrink-0 bg-[#18181c] p-8 lg:p-10 flex flex-col justify-between border-b md:border-b-0 md:border-r border-[#222226] overflow-y-auto">
        
        <div className="space-y-8">
          {/* Top Logo + Checkout Title */}
          <div className="flex items-center gap-3">
            <LogoIcon size={30} />
            <h1 className="text-[20px] font-black text-white tracking-wide">
              Checkout
            </h1>
          </div>

          {/* Cart Items List with Big 3:4 Poster Art */}
          <div className="space-y-5">
            {items.map((item) => (
              <div key={item.id} className="flex items-start gap-4 group">
                <div className="relative w-[68px] h-[90px] bg-[#1c1c20] border border-[#2a2a30] rounded-lg overflow-hidden flex-shrink-0 shadow-md">
                  <Image
                ...
                <div className="flex-1 min-w-0 pt-1">
                  <h3 className="font-semibold text-[15px] text-white line-clamp-2 leading-snug">
                    {item.name}
                  </h3>
          ...
          {/* Price Breakdown */}
          <div className="space-y-3 pt-6 border-t border-[#242428] text-[13.5px]">
            ...
            {/* Total Price Row */}
            <div className="flex justify-between items-baseline pt-4 border-t border-[#242428]">
              <span className="text-[17px] font-bold text-white">Total</span>
              <span className="text-[30px] font-black text-white tracking-tight">
          ...
          {!isFree && (
            <div className="inline-flex items-center gap-2.5 bg-[#0e2c22] border border-[#1b5e46] text-[#2ed8a7] px-4 py-2.5 rounded-xl text-[12px] font-semibold select-none w-full shadow-sm">
              <div className="w-4 h-4 rounded-full bg-[#1b5e46] flex items-center justify-center text-[#2ed8a7] flex-shrink-0">
                <Sparkles size={11} />
              </div>
        ...
        <div className="pt-6 text-[11px] text-zinc-500 select-none">
      ...
      {/* ========================================================================= */}
      {/* RIGHT COLUMN: PAYMENT DETAILS & ACTIONS (1:1 Proportions & Typography)    */}
      {/* ========================================================================= */}
      <div className="flex-1 bg-[#141416] p-8 lg:p-10 flex flex-col justify-between overflow-y-auto space-y-7">
        ...
        <div className="space-y-7">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2.5 text-[13px] font-semibold text-zinc-300">
              <div className="w-6 h-6 rounded-full bg-[#26262a] border border-[#38383e] text-white flex items-center justify-center text-[11px] font-bold">
                {initialLetter}
              </div>
          ...
          <div className="bg-[#1e1e22] border border-[#2c2c30] rounded-xl p-4 transition-all">
            <button
              type="button"
            ...
            >
              <div className="flex items-center gap-3">
                <div className="w-5 h-5 rounded-full bg-[#0e2c22] border border-[#1b5e46] flex items-center justify-center text-[#2ed8a7]">
                  <Sparkles size={12} />
                </div>
                <span className="text-[14px] font-bold text-white">Producer Rewards</span>
              </div>
            ...
            {isRewardsExpanded && (
              <div className="mt-3 pt-3 border-t border-[#2a2a2e] text-[13px] text-zinc-400 space-y-1.5 animate-in fade-in duration-150">
          ...
          {!isFree && (
            <div className="space-y-2.5">
              <div className="bg-[#18181c] border border-[#2a2a2e] rounded-xl divide-y divide-[#242428] overflow-hidden">
                ...
                >
                  <div className="flex items-center gap-3.5">
                    <div className="w-9 h-6 rounded bg-[#26262a] border border-[#36363c] flex items-center justify-center">
                  ...
                  <div className={`w-[18px] h-[18px] rounded-full border flex items-center justify-center transition-all ${
                    ...
                    {selectedMethod === 'card' && <div className="w-2 h-2 rounded-full bg-black" />}
                  </div>
                </label>
                ...
                >
                  ...
                  <div className={`w-[18px] h-[18px] rounded-full border flex items-center justify-center transition-all ${
                    ...
                    {selectedMethod === 'paypal' && <div className="w-2 h-2 rounded-full bg-black" />}
                  </div>
                </label>
                ...
                >
                  ...
                  <div className={`w-[18px] h-[18px] rounded-full border flex items-center justify-center transition-all ${
                    ...
                    {selectedMethod === 'gpay' && <div className="w-2 h-2 rounded-full bg-black" />}
                  </div>
                </label>
                ...
                >
                  ...
                  <div className={`w-[18px] h-[18px] rounded-full border flex items-center justify-center transition-all ${
                    ...
                    {selectedMethod === 'upi' && <div className="w-2 h-2 rounded-full bg-black" />}
                  </div>
                </label>

                {/* Expanded methods if opened */}
                {showAllMethods && (
                  <div className="p-4 bg-[#141418] space-y-2.5 text-[13px] text-zinc-400 animate-in fade-in duration-150">
                    <div className="flex items-center gap-2.5">
                      <img src="/payment-logos/rupay.svg" alt="RuPay" className="h-4" />
                      <img src="/payment-logos/visa.svg" alt="Visa" className="h-4" />
                      <img src="/payment-logos/mastercard.svg" alt="Mastercard" className="h-4" />
                      <img src="/payment-logos/amex.svg" alt="Amex" className="h-4" />
              ...
              <button
                ...
                className="inline-flex items-center gap-1.5 text-[13px] font-bold text-zinc-300 hover:text-white transition-colors cursor-pointer py-1.5"
              >
                <span>{showAllMethods ? 'Show less' : 'All payment methods'}</span>
                {showAllMethods ? <ChevronUp size={15} /> : <ChevronDown size={15} />}
              </button>
            </div>
          )}
          ...
          <div>
            {!isCreatorCodeOpen ? (
              <button
                ...
                className="h-10 px-4.5 bg-[#242428] hover:bg-[#2e2e34] border border-[#303036] text-white text-[13px] font-semibold rounded-[6px] flex items-center gap-2 transition-colors cursor-pointer"
              >
                <Plus size={14} />
                <span>Creator Code</span>
              </button>
            ) : (
              <div className="space-y-2.5 bg-[#1c1c20] border border-[#2a2a30] p-3 rounded-xl animate-in fade-in duration-150">
                <div className="flex gap-2">
                  <input
                    ...
                    className="flex-1 h-9 bg-[#141416] border border-[#2c2c30] text-white text-xs px-3 rounded-md outline-none uppercase font-semibold placeholder:text-zinc-500 focus:border-zinc-400"
                  />
                  <button
                    type="button"
                    onClick={onApplyCoupon}
                    disabled={couponLoading || !coupon.trim()}
                    className="px-4 h-9 bg-white hover:bg-zinc-200 text-black text-xs font-bold rounded-md transition-colors cursor-pointer disabled:opacity-40"
                  >
          ...
          <div className="pt-1">
            <button
              ...
              className="w-full flex items-center justify-between text-[13px] font-semibold text-zinc-400 hover:text-white py-1 cursor-pointer select-none"
            >
          ...
          {selectedMethod === 'paypal' && !isFree ? (
            user?.id ? (
              ...
              <Link
                ...
                className="w-full h-12 bg-white hover:bg-zinc-200 text-black font-black uppercase text-xs tracking-wider rounded-[6px] transition-all shadow-md flex items-center justify-center cursor-pointer"
              >
            ...
            <button
              ...
              className="w-full h-12 bg-white hover:bg-zinc-200 text-black font-black uppercase text-xs tracking-wider rounded-[6px] transition-all shadow-md flex items-center justify-center gap-2 cursor-pointer disabled:opacity-50 active:scale-[0.99]"
            >
              {loading ? (
