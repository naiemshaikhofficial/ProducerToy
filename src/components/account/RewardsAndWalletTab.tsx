...
// 8-point sparkle circle icon for Toywards
export const ToywardsSparkleIcon: React.FC<{ className?: string; size?: number }> = ({
  className = 'w-4 h-4',
  size = 16,
}) => (
  <svg
...
export const RewardsAndWalletTab: React.FC<RewardsAndWalletTabProps> = ({
  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-150 font-sans select-none max-w-4xl">
      ...
      {/* 3. Empty State / Activity History Section */}
      <div className="pt-2">
        {loading ? (
